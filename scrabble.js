...
/*
* I used this line of code: var draggableID = ui.draggable.attr("id");
* to get the id of the tile what was dropped on a given slot.
* I learned about this trick from Jason Downing's sample code that was 
* demonstrated in class by Prof. Heines. In the code it was documented that
* this line of code originally came from stackoverflow.com
*/
